$(document).ready(function(){
	var QUERY_URL = 'http://139.59.28.75/ona_export_tool_ncell_awareness_campaign/script.php'
	var SERVER_URL = 'http://139.59.28.75/ona_export_tool_ncell_awareness_campaign/'
	var fromDate = '';
	var toDate = ''
	var formType = '';
	new Pikaday({
