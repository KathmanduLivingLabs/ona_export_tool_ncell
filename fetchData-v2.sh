...
do
	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/68589.json >schools_temp.json
done
...
do
	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/68590.json >buildings_temp.json
done
...
do
	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/80364.json >building_elements_temp.json
done
...
#do
#	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/68589.csv >school_temp.csv
#done
...
#do
#	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/68590.csv >building_temp.csv
#done
...
#do
#	curl -X GET -u "klltesting:klltesting" https://api.ona.io/api/v1/data/80364.csv >buildingelement_temp.csv
#done
