...
while [$(stat --printf="%s" schools.json)=0]
do
...
while [$(stat --printf="%s" buildings.json)=0]
do
...
while [$(stat --printf="%s" building_elements.json)=0]
do
...
while [$(stat --printf="%s" school.csv)=0]
do
...
while [$(stat --printf="%s" building.csv)=0]
do
...
while [$(stat --printf="%s" buildingelement.csv)=0]
do
