...
curl -X GET -u $onaAuth https://api.ona.io/api/v1/data/113425.csv > schooldk10.csv
...
curl -X GET -u $onaAuth https://api.ona.io/api/v1/data/113426.csv > buildingdk10.csv
...
curl -X GET -u $onaAuth https://api.ona.io/api/v1/data/113427.csv > buildingelementdk10.csv
